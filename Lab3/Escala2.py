...
def escala(sx, sy, matriz1):

    matrizEscala = np.array([[sx, 0, 0],
                            [0, sy, 0],
                            [0, 0, 1]])

    matriz2 = np.dot(matrizEscala, matriz1)
    return matriz2
...
def main():
    ...
    while True:
        ...
        matriz2 = np.array(escala(2, 4, matriz1))
