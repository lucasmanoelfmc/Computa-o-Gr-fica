...
def translacao(tx, ty, matriz1):

    matrizTrans = np.array([[1, 0, tx],
                            [0, 1, ty],
                            [0, 0, 1]])

    matriz2 = np.dot(matrizTrans, matriz1)
    return matriz2
...
pg.display.set_caption("Translação")
...
def main():
    ...
    while True:
        ...
        matriz2 = np.array(translacao(50, 50, matriz1))
